  ...
  return (
    <div className="">
      <div className="d-flex flex-column">
        <ul
          className="sidebar-media navbar-nav bg-gradient-primary sidebar sidebar-primary flag bg-primary text-white"
          id="accordionSidebar"
          style={sidebar}
        >
          <Link
          ...
          <li className="nav-item fs-5 text-start">
            <Link to="/components" className="nav-link" style={styling}>
              {flag ? (
                <div>
                  <Componentsmenu />
                </div>
          ...
          <div className="sidebar-heading opacity-50 text-start ps-3">
            Addons
          </div>
